  ...
  return (
    <main className="min-h-screen bg-background px-5 py-8 text-foreground">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-3"><Link href="/dashboard" className="rounded-2xl border border-border bg-card p-5 transition hover:border-primary/40"><CalendarDays className="size-5 text-primary" /><p className="mt-6 font-semibold">Bookings</p><p className="mt-1 text-sm text-muted-foreground">Manage upcoming help</p></Link><div className="rounded-2xl border border-border bg-card p-5"><ShieldCheck className="size-5 text-primary" /><p className="mt-6 font-semibold">Safety centre</p><p className="mt-1 text-sm text-muted-foreground">Your protection tools</p></div><div className="rounded-2xl border border-border bg-card p-5"><LogOut className="size-5 text-primary" /><p className="mt-6 font-semibold">Session</p><p className="mt-1 text-sm text-muted-foreground">Signed in securely</p></div></div>
        <AccountActions />
      </div>
    </main>
  )
